/**
 * @license AngularJS v1.2.33-local+sha.90f480f
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.33-local+sha.90f480f/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.33-local+sha.90f480f',    // all of these placeholder strings will be replaced by grunt's
